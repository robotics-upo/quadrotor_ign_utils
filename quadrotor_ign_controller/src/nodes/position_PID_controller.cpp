...
#include <quadrotor_ign_controller/ControlConfig.h>
...
public:
  ...
  //Dynamic reconfigure
  std::unique_ptr<dynamic_reconfigure::Server<quadrotor_ign_controller::ControlConfig>> server;
  std::unique_ptr<dynamic_reconfigure::Server<quadrotor_ign_controller::ControlConfig>::CallbackType> f;
  ...
  void dynReconfCb(quadrotor_ign_controller::ControlConfig &config, uint32_t level);
};
...
//:filtered_error_(3,0)
{
  ...
  server.reset(new dynamic_reconfigure::Server<quadrotor_ign_controller::ControlConfig>);
  f.reset(new dynamic_reconfigure::Server<quadrotor_ign_controller::ControlConfig>::CallbackType);
...
void PositionPID::dynReconfCb(quadrotor_ign_controller::ControlConfig &config, uint32_t level)
{
